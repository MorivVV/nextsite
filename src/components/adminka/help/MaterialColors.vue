<template>
  <div id="palette" class="section scrollspy">
    <div class="center">
      Классы для применения к тексту дополняются постфиксом -text для основогоно
      цвета
      <div class="flow-text">red-text</div>
      И префиксом при использовании модификатора цвета
      <div class="flow-text">text-lighten-5</div>
    </div>
    ...
    <div class="row dynamic-color">
      <div class="col s12 m6 l4">
        ...
        <div class="red darken-1" style="color: rgba(255, 255, 255, 0.9);">
          <span>#e53935 red darken-1</span>
        </div>
        <div class="red darken-2" style="color: rgba(255, 255, 255, 0.9);">
          <span>#d32f2f red darken-2</span>
        </div>
        <div class="red darken-3" style="color: rgba(255, 255, 255, 0.9);">
          <span>#c62828 red darken-3</span>
        </div>
        <div class="red darken-4" style="color: rgba(255, 255, 255, 0.9);">
      ...
      <div class="col s12 m6 l4">
        ...
        <div class="pink darken-1" style="color: rgba(255, 255, 255, 0.9);">
          <span>#d81b60 pink darken-1</span>
        </div>
        <div class="pink darken-2" style="color: rgba(255, 255, 255, 0.9);">
          <span>#c2185b pink darken-2</span>
        </div>
        <div class="pink darken-3" style="color: rgba(255, 255, 255, 0.9);">
          <span>#ad1457 pink darken-3</span>
        </div>
        <div class="pink darken-4" style="color: rgba(255, 255, 255, 0.9);">
      ...
      <div class="col s12 m6 l4">
        ...
        <div class="purple darken-1" style="color: rgba(255, 255, 255, 0.9);">
          <span>#8e24aa purple darken-1</span>
        </div>
        <div class="purple darken-2" style="color: rgba(255, 255, 255, 0.9);">
          <span>#7b1fa2 purple darken-2</span>
        </div>
        <div class="purple darken-3" style="color: rgba(255, 255, 255, 0.9);">
          <span>#6a1b9a purple darken-3</span>
        </div>
        <div class="purple darken-4" style="color: rgba(255, 255, 255, 0.9);">
      ...
      <div class="col s12 m6 l4">
        ...
        <div class="indigo darken-1" style="color: rgba(255, 255, 255, 0.9);">
          <span>#3949ab indigo darken-1</span>
        </div>
        <div class="indigo darken-2" style="color: rgba(255, 255, 255, 0.9);">
          <span>#303f9f indigo darken-2</span>
        </div>
        <div class="indigo darken-3" style="color: rgba(255, 255, 255, 0.9);">
          <span>#283593 indigo darken-3</span>
        </div>
        <div class="indigo darken-4" style="color: rgba(255, 255, 255, 0.9);">
      ...
      <div class="col s12 m6 l4">
        ...
        <div class="blue darken-1" style="color: rgba(255, 255, 255, 0.9);">
          <span>#1e88e5 blue darken-1</span>
        </div>
        <div class="blue darken-2" style="color: rgba(255, 255, 255, 0.9);">
          <span>#1976d2 blue darken-2</span>
        </div>
        <div class="blue darken-3" style="color: rgba(255, 255, 255, 0.9);">
          <span>#1565c0 blue darken-3</span>
        </div>
        <div class="blue darken-4" style="color: rgba(255, 255, 255, 0.9);">
      ...
      <div class="col s12 m6 l4">
        ...
        <div class="cyan darken-1" style="color: rgba(255, 255, 255, 0.9);">
          <span>#00acc1 cyan darken-1</span>
        </div>
        <div class="cyan darken-2" style="color: rgba(255, 255, 255, 0.9);">
          <span>#0097a7 cyan darken-2</span>
        </div>
        <div class="cyan darken-3" style="color: rgba(255, 255, 255, 0.9);">
          <span>#00838f cyan darken-3</span>
        </div>
        <div class="cyan darken-4" style="color: rgba(255, 255, 255, 0.9);">
      ...
      <div class="col s12 m6 l4">
        ...
        <div class="teal darken-1" style="color: rgba(255, 255, 255, 0.9);">
          <span>#00897b teal darken-1</span>
        </div>
        <div class="teal darken-2" style="color: rgba(255, 255, 255, 0.9);">
          <span>#00796b teal darken-2</span>
        </div>
        <div class="teal darken-3" style="color: rgba(255, 255, 255, 0.9);">
          <span>#00695c teal darken-3</span>
        </div>
        <div class="teal darken-4" style="color: rgba(255, 255, 255, 0.9);">
      ...
      <div class="col s12 m6 l4">
        ...
        <div class="green darken-1" style="color: rgba(255, 255, 255, 0.9);">
          <span>#43a047 green darken-1</span>
        </div>
        <div class="green darken-2" style="color: rgba(255, 255, 255, 0.9);">
          <span>#388e3c green darken-2</span>
        </div>
        <div class="green darken-3" style="color: rgba(255, 255, 255, 0.9);">
          <span>#2e7d32 green darken-3</span>
        </div>
        <div class="green darken-4" style="color: rgba(255, 255, 255, 0.9);">
      ...
      <div class="col s12 m6 l4">
        ...
        <div class="lime darken-1" style="color: rgba(255, 255, 255, 0.9);">
          <span>#c0ca33 lime darken-1</span>
        </div>
        <div class="lime darken-2" style="color: rgba(255, 255, 255, 0.9);">
          <span>#afb42b lime darken-2</span>
        </div>
        <div class="lime darken-3" style="color: rgba(255, 255, 255, 0.9);">
          <span>#9e9d24 lime darken-3</span>
        </div>
        <div class="lime darken-4" style="color: rgba(255, 255, 255, 0.9);">
      ...
      <div class="col s12 m6 l4">
        ...
        <div class="yellow darken-1" style="color: rgba(255, 255, 255, 0.9);">
          <span>#fdd835 yellow darken-1</span>
        </div>
        <div class="yellow darken-2" style="color: rgba(255, 255, 255, 0.9);">
          <span>#fbc02d yellow darken-2</span>
        </div>
        <div class="yellow darken-3" style="color: rgba(255, 255, 255, 0.9);">
          <span>#f9a825 yellow darken-3</span>
        </div>
        <div class="yellow darken-4" style="color: rgba(255, 255, 255, 0.9);">
      ...
      <div class="col s12 m6 l4">
        ...
        <div class="amber darken-1" style="color: rgba(255, 255, 255, 0.9);">
          <span>#ffb300 amber darken-1</span>
        </div>
        <div class="amber darken-2" style="color: rgba(255, 255, 255, 0.9);">
          <span>#ffa000 amber darken-2</span>
        </div>
        <div class="amber darken-3" style="color: rgba(255, 255, 255, 0.9);">
          <span>#ff8f00 amber darken-3</span>
        </div>
        <div class="amber darken-4" style="color: rgba(255, 255, 255, 0.9);">
      ...
      <div class="col s12 m6 l4">
        ...
        <div class="orange darken-1" style="color: rgba(255, 255, 255, 0.9);">
          <span>#fb8c00 orange darken-1</span>
        </div>
        <div class="orange darken-2" style="color: rgba(255, 255, 255, 0.9);">
          <span>#f57c00 orange darken-2</span>
        </div>
        <div class="orange darken-3" style="color: rgba(255, 255, 255, 0.9);">
          <span>#ef6c00 orange darken-3</span>
        </div>
        <div class="orange darken-4" style="color: rgba(255, 255, 255, 0.9);">
      ...
      <div class="col s12 m6 l4">
        ...
        <div class="deep-orange accent-4">
      ...
      <div class="col s12 m6 l4">
        ...
        <div class="brown darken-1" style="color: rgba(255, 255, 255, 0.9);">
          <span>#6d4c41 brown darken-1</span>
        </div>
        <div class="brown darken-2" style="color: rgba(255, 255, 255, 0.9);">
          <span>#5d4037 brown darken-2</span>
        </div>
        <div class="brown darken-3" style="color: rgba(255, 255, 255, 0.9);">
          <span>#4e342e brown darken-3</span>
        </div>
        <div class="brown darken-4" style="color: rgba(255, 255, 255, 0.9);">
      ...
      <div class="col s12 m6 l4">
        ...
        <div class="grey darken-1" style="color: rgba(255, 255, 255, 0.9);">
          <span>#757575 grey darken-1</span>
        </div>
        <div class="grey darken-2" style="color: rgba(255, 255, 255, 0.9);">
          <span>#616161 grey darken-2</span>
        </div>
        <div class="grey darken-3" style="color: rgba(255, 255, 255, 0.9);">
          <span>#424242 grey darken-3</span>
        </div>
        <div class="grey darken-4" style="color: rgba(255, 255, 255, 0.9);">
    ...
    <div class="row dynamic-color">
      <div class="col s12 m6 l4">
        <div class="blue-grey lighten-5">
          <span>#eceff1 blue-grey lighten-5</span>
        </div>
        <div class="blue-grey lighten-4">
          <span>#cfd8dc blue-grey lighten-4</span>
        </div>
        <div class="blue-grey lighten-3">
          <span>#b0bec5 blue-grey lighten-3</span>
        </div>
        <div class="blue-grey lighten-2">
          <span>#90a4ae blue-grey lighten-2</span>
        </div>
        <div class="blue-grey lighten-1">
          <span>#78909c blue-grey lighten-1</span>
        </div>
        <div class="blue-grey"><span>#607d8b blue-grey</span></div>
        <div
          class="blue-grey darken-1"
          style="color: rgba(255, 255, 255, 0.9);"
        >
          <span>#546e7a blue-grey darken-1</span>
        </div>
        <div
          class="blue-grey darken-2"
          style="color: rgba(255, 255, 255, 0.9);"
        >
          <span>#455a64 blue-grey darken-2</span>
        </div>
        <div
          class="blue-grey darken-3"
          style="color: rgba(255, 255, 255, 0.9);"
        >
          <span>#37474f blue-grey darken-3</span>
        </div>
        <div
          class="blue-grey darken-4"
          style="color: rgba(255, 255, 255, 0.9);"
        >
          <span>#263238 blue-grey darken-4</span>
        </div>
      </div>
      <div class="col s12 m6 l4">
        <div class="black" style="color: rgba(255, 255, 255, 0.9);">
          <span>#000000 black</span>
        </div>
        <div class="white"><span>#ffffff white</span></div>
        <div class="transparent"><span>N/A transparent</span></div>
      </div>
    </div>
  </div>
</template>
